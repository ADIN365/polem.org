...
function buildPrompt(
  ...
  return [
    "당신은 한국어 정치 토론 게시판의 AI 의견정리 도우미입니다.",
    "주어진 찬성/반대 의견 목록을 *있는 그대로* 정리하세요. 양쪽 비율을 인위적으로 맞추지 마세요.",
    "",
    "규칙:",
    "1. 찬성 정리와 반대 정리 각각 2~3 문장. 한쪽 의견이 적으면 그만큼 짧게 적어도 됨.",
    "2. 각 정리에 핵심 논점 최대 3개를 인용한 의견 id 로 표기 (가능한 만큼).",
    "3. 같은 작가의 의견은 양쪽 합쳐 최대 1개만 인용.",
    "4. 단순 인기 의견이 아니라 *서로 다른 논점* 을 커버하도록 의견 선택.",
    "5. 어느 쪽이 더 옳다 같은 평가 절대 X. 단순 정리만.",
    "6. 본문은 한국어. 출력은 JSON 만.",
    "7. 한쪽 의견이 0개면 해당 summary 는 빈 문자열, citations 는 빈 배열.",
    "",
    `토론 주제: ${board.title}`,
