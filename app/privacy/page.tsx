  ...
  return (
    <LegalLayout title="개인정보처리방침" updated="2026-05-09">
      ...
      <ul>
        ...
        <li>이용 기록: 박제·댓글·동조·블라인드 답변·신고 내역, 접속 IP·User-Agent (관리·보안 목적)</li>
      ...
      <ul>
        ...
        <li>박제·댓글·신고 등 서비스 기능 제공</li>
        <li>이용약관 위반 대응 및 분쟁 해결</li>
        <li>본인에게만 제공되는 *가치관 4축 좌표* 와 *토론 주제별 자기 거울* 산출 (헌법 §2.3)</li>
      </ul>
      ...
      <ul>
        ...
        <li>박제·댓글: 영구 보관 (서비스 성격). 탈퇴 시 작성자는 익명화하되 콘텐츠 자체는 보존</li>
      </ul>
      ...
      <p>
        AI 모델 호출 시 *박제 본문·토론 주제 제목* 등이 처리 위탁됩니다. 개인 식별 정보는 전송되지 않습니다.
      </p>
